 ...
 *
 * There are 5 types of args nodes: `<simpleArgs>`, `<menuArgs>`, `<cycleArgs>`, `<enumArgs>`, `<commandArg>`.
 *
 * A simple summary:
 ...
 * - `<enumArgs>` is a dynamic iteration of `<simpleArgs>`. It starts with a MenuForm with an "Add" and a "Submit" button. The "Add" button will open a CustomForm in a similar manner as `<simpleArgs>` according to the `<each>` node in `<enumArgs>`. The CustomForm will append a new object to the unordered result list and show up on the original MenuForm. Clicking on the object deletes it from the list.
